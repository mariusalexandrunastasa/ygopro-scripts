-- ラーの翼神竜 The Winged Dragon of Ra (Anime)
function c10000010.initial_effect(c)
	...
	e1:SetCondition(c10000010.sumoncon)
	e1:SetOperation(c10000010.sumonop)
	...
	e8:SetValue(c10000010.tgfilter)
	c:RegisterEffect(e8)
	--immune effect
	...
	e11:SetCountLimit(1)
	e11:SetOperation(c10000010.atkdefresetop)
	...
	e12:SetCondition(c10000010.stgcon)
	e12:SetTarget(c10000010.stgtg)
	e12:SetOperation(c10000010.stgop)
	c:RegisterEffect(e12)
	--atk
	local e13=Effect.CreateEffect(c)
	e13:SetType(EFFECT_TYPE_SINGLE)
	e13:SetCode(EFFECT_MATERIAL_CHECK)
	e13:SetValue(c10000010.valcheck)
	c:RegisterEffect(e13)
	local e14=Effect.CreateEffect(c)
	e14:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_CONTINUOUS)
	e14:SetCode(EVENT_SUMMON_SUCCESS)
	e14:SetOperation(c10000010.atkdefop)
	...
	e15:SetCost(c10000010.payatkcost)
	e15:SetOperation(c10000010.payatkop)
	...
	e16:SetCondition(c10000010.negcon)
	e16:SetOperation(c10000010.negop)
	...
	e18:SetCondition(c10000010.egpcon)
	e18:SetOperation(c10000010.egpop)
	c:RegisterEffect(e18)
	--De-Fusion
	if not c10000010.global_check then
		c10000010.global_check=true
		local df=Effect.CreateEffect(c)
		df:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS)
		df:SetCode(EVENT_ADJUST)
		df:SetOperation(c10000010.dfop)
		Duel.RegisterEffect(df,0)
	end
end
function c10000010.dffilter(c)
	return c:IsCode(95286165)
end
function c10000010.dfop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local g=Duel.GetMatchingGroup(c10000010.dffilter,c:GetControler(),0xff,0xff,nil)
	local tc=g:GetFirst()
	while tc do
		if tc:GetFlagEffect(51100236)==0 then
			...
			e1:SetTarget(c10000010.tg)
			e1:SetOperation(c10000010.op)
...
function c10000010.dffilter2(c)
	return c:IsFaceup() and c:IsType(TYPE_FUSION) and (c:IsCode(10000010) or c:IsCode(511000237))
end
function c10000010.tg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsLocation(LOCATION_MZONE) and c10000010.dffilter2(chkc) end
	if chk==0 then return Duel.IsExistingTarget(c10000010.dffilter2,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_FACEUP)
	local g=Duel.SelectTarget(tp,c10000010.dffilter2,tp,LOCATION_MZONE,LOCATION_MZONE,1,1,nil)
	Duel.SetOperationInfo(0,CATEGORY_RECOVER,nil,0,tp,g:GetFirst():GetAttack())
end
function c10000010.op(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
...
function c10000010.sumoncon(e,c)
	if c==nil then return true end
	return Duel.GetLocationCount(c:GetControler(),LOCATION_MZONE)>-3 and Duel.GetTributeCount(c)>=3
end
function c10000010.sumonop(e,tp,eg,ep,ev,re,r,rp,c)
...
function c10000010.atkdefresetop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local e1=Effect.CreateEffect(c)
	e1:SetType(EFFECT_TYPE_SINGLE)
...
function c10000010.stgcon(e,tp,eg,ep,ev,re,r,rp)
	return bit.band(e:GetHandler():GetSummonType(),SUMMON_TYPE_SPECIAL)==SUMMON_TYPE_SPECIAL
end
function c10000010.stgtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.SetOperationInfo(0,CATEGORY_TOGRAVE,e:GetHandler(),1,0,0)
end
function c10000010.stgop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
...
function c10000010.payatkcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckLPCost(tp,2) end
	local lp=Duel.GetLP(tp)
	e:SetLabel(lp-1)
	Duel.PayLPCost(tp,lp-1)
end
function c10000010.payatkop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local lp=e:GetLabel()
...
function c10000010.egpcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsPreviousLocation(LOCATION_GRAVE)
end
function c10000010.egpop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if c:IsFaceup() then
		...
		e3:SetCountLimit(1)
		e3:SetCost(c10000010.descost)
		e3:SetTarget(c10000010.destg)
		e3:SetOperation(c10000010.desop)
		e3:SetReset(RESET_EVENT+0x1fe0000)
		c:RegisterEffect(e3)
		...
		e4:SetCost(c10000010.tatkcost)
		e4:SetOperation(c10000010.tatkop)
		...
		e6:SetCondition(c10000010.uncon)
		e6:SetOperation(c10000010.unop)
		...
		e7:SetTarget(c10000010.valtg)
		e7:SetValue(c10000010.vala)
		...
		e8:SetCondition(c10000010.dircon)
		e8:SetOperation(c10000010.dirop)
...
function c10000010.tatkcost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c10000010.tatkop(e,tp,eg,ep,ev,re,r,rp)
...
function c10000010.negcon(e,tp,eg,ep,ev,re,r,rp)
...
function c10000010.negop(e,tp,eg,ep,ev,re,r,rp)
	Duel.NegateAttack()
end
